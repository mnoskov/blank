 ...
 */
var yandexReachGoal=function(a){if(window.Ya)for(var o=(window.Ya.Metrika||window.Ya.Metrika2).counters(),e=0;e<o.length;e++){var n="yaCounter"+o[e].id;window[n]&&window[n].reachGoal(a)}},googleReachGoal=function(a,o){"function"==typeof gtag?gtag("event",o,{event_category:a}):"undefined"!=typeof GoogleAnalyticsObject?window[GoogleAnalyticsObject]("send","event",a,o):null!=_gaq&&"function"==typeof _gaq.push&&_gaq.push(["_trackEvent",o,o])},reachGoal=function(a){var o,e="";(o=a.match(/^(.+?):(.+?)$/))&&(e=o[1],a=o[2]),yandexReachGoal(a),e&&(yandexReachGoal(e),googleReachGoal(e,a))};$.fn.reachGoal=function(){return this.filter("[data-goal]").each(function(){reachGoal($(this).data("goal"))})},$(document).on("success-submit","[data-goal]",function(){$(this).reachGoal()});
